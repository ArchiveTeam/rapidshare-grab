...
LUA_SHA1 = get_hash(os.path.join(CWD, 'rapidshare.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            "--warc-header", "rapidshare-dld-script-version: " + VERSION,
            "--warc-header", ItemInterpolation("rapidshare-user: %(item_name)s"),
        ]
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="rapidshare"),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
